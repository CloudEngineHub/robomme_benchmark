    ...
    def step(self, action):
        ...
        if self.save_video and current_task!='NO RECORD':
            ...
            record_data = {
                ...
                'subgoal_online': subgoal_online_text,
                ...
                'subgoal_online_grounded': self.current_subgoal_segment_online_filled
            }
    ...
    def close(self):
        ...
        if self.episode_success:
            ...
            for record_data in self.buffer:
                ...
                online_task_name = record_data.get('subgoal_online', 'Unknown')
                if isinstance(online_task_name, str):
                    task_name_encoded = online_task_name.encode('utf-8')
                else:
                    task_name_encoded = online_task_name
                ts_group.create_dataset("subgoal_online", data=task_name_encoded)
                ...
                task_name_online = record_data.get('subgoal_online_grounded', 'Unknown')
                if isinstance(task_name_online, str):
                    task_name_encoded = task_name_online.encode('utf-8')
                else:
                    task_name_encoded = task_name_online
                ts_group.create_dataset("subgoal_online_grounded", data=task_name_encoded)
