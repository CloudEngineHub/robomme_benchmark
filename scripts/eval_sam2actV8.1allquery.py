                ...
                if callable(solve_callable):
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            print(f"  [Demo Step {demo_step}] Model queried (action not executed, using preset action)")
                        else:
                            print(f"  [Demo Step {demo_step}] Model query failed: {response.status_code} - {response.text}")
                    except Exception as e:
                        print(f"  [Demo Step {demo_step}] Error querying model: {e}")
